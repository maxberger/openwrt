...
static struct gpio_led dlan_1200_wifi_ac_leds_gpio[] __initdata = {
	{
...
static struct gpio_keys_button dlan_1200_wifi_ac_gpio_keys[] __initdata = {
	{
		.desc		= "dLAN button",
		.type		= EV_KEY,
		.code		= BTN_0,
...
static struct ar8327_pad_cfg dlan_1200_wifi_ac_ar8327_pad0_cfg = {
...
static struct ar8327_pad_cfg dlan_1200_wifi_ac_ar8327_pad5_cfg = {
	.mode = 0,
	.txclk_delay_en = 0,
	.rxclk_delay_en = 0,
	.txclk_delay_sel = 0,
...
static struct ar8327_platform_data dlan_1200_wifi_ac_ar8327_data = {
	.pad0_cfg = &dlan_1200_wifi_ac_ar8327_pad0_cfg,
	.pad5_cfg = &dlan_1200_wifi_ac_ar8327_pad5_cfg,
	.port0_cfg = {
		.force_link = 1,
...
static struct mdio_board_info dlan_1200_wifi_ac_mdio0_info[] = {
	{
		.bus_id = "ag71xx-mdio.0",
		.phy_addr = 0,
		.platform_data = &dlan_1200_wifi_ac_ar8327_data,
	},
};

static void __init dlan_1200_wifi_ac_setup(void)
{
	...
	ath79_register_leds_gpio(-1, ARRAY_SIZE(dlan_1200_wifi_ac_leds_gpio),
				 dlan_1200_wifi_ac_leds_gpio);

	ath79_register_gpio_keys_polled(-1, DLAN_PRO_1200_AC_KEYS_POLL_INTERVAL,
					ARRAY_SIZE(dlan_1200_wifi_ac_gpio_keys),
					dlan_1200_wifi_ac_gpio_keys);
	...
	mdiobus_register_board_info(dlan_1200_wifi_ac_mdio0_info,
				    ARRAY_SIZE(dlan_1200_wifi_ac_mdio0_info));
...
MIPS_MACHINE(ATH79_MACH_DLAN_1200_WIFI_AC, "dLAN-1200-wifi-ac", "devolo dLAN 1200+ WiFi ac",
	     dlan_1200_wifi_ac_setup);
